...
r1headzappvar.controller('login', function($scope,$state,$cookieStore,$rootScope,contentservice) {



});

r1headzappvar.controller('signup', function($scope,$state,$cookieStore,$rootScope,contentservice) {
...
r1headzappvar.controller('contactus', function($scope,$state,$cookieStore,$rootScope,contentservice) {

});


r1headzappvar.controller('reviews', function($scope,$state,$cookieStore,$rootScope,contentservice) {

});

r1headzappvar.controller('treatmentandservices', function($scope,$state,$cookieStore,$rootScope,contentservice) {

});

r1headzappvar.controller('productlisting', function($scope,$state,$cookieStore,$rootScope,contentservice) {

});

r1headzappvar.controller('productdetails', function($scope,$state,$cookieStore,$rootScope,contentservice) {
